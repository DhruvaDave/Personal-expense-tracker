...
class ExpenseCustomForm extends React.Component {
    ...
    handleFormSubmit = (event, requestType, userExpensesID) => {
        ...
        switch ( requestType ) {
            case 'post':
                ...
                // }
                return axios.post('http://127.0.0.1:8000/user-expenses/', {
                    from_date: from_date,
            ...
            case 'put':
                return axios.put(`http://127.0.0.1:8000/user-expenses/${userExpensesID}/`, {
                    from_date: from_date,
                    type_of_expense: type_of_expense,
                    amount: amount,
    ...
    onChangeUserIncome = (income,income_obj) => {
        ...
        this.setState({
            ...
            selected_user_income_date : income_obj.props.children[0] + '/' + income_obj.props.children[2]
        });
      }
    ...
    render() {
        ...
        <div>
            ...
            <FormItem label="Type of Expense" >
                <Input.Group compact>
                    <Select name="type_of_expense" defaultValue="Debit" onChange={this.onChangeTypeOfExpense} style={{ width: '30%' }}>
            ...
            <FormItem label="User" >
                <Input.Group compact>
                    <Select name="user_id" defaultValue="" onChange={this.onChangeUser} style={{ width: '30%' }}>
            ...
            <FormItem label="User Income" >
                <Input.Group compact>
                    <Select name="user_income_id" defaultValue="" onChange={this.onChangeUserIncome} style={{ width: '30%' }}>
                        {this.state.all_user_income.map(income => (
                            <Option value={income.id}>{income.from_date}   -  {income.to_date}</Option>
                        ))}
                    </Select>
                </Input.Group>
            </FormItem>
            ...
            <FormItem label="Amount" >
                <Input name="amount" placeholder="Enter some Amount ..." style={{ width: '30%' }}/>
            </FormItem>
            <FormItem>
