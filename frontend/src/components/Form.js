...
class CustomForm extends React.Component {
    ...
    handleFormSubmit = (event, requestType, userIncomeID) => {
        ...
        switch ( requestType ) {
            case 'post':
                return axios.post('http://127.0.0.1:8000/user-income/', {
                    from_date: from_date,
                    to_date: to_date,
                    credit: credit,
                    // user_id: user_id,
            ...
            case 'put':
                return axios.put(`http://127.0.0.1:8000/user-income/${userIncomeID}/`, {
                    from_date: from_date,
                    to_date: to_date,
                    credit: credit,
    ...
    render() {
        ...
        <div>
            ...
            <FormItem label="Credit Amount" >
                <Input name="credit" placeholder="Enter some Credit Amount ..." style={{ width: '30%' }}/>
            </FormItem>
            <FormItem>
